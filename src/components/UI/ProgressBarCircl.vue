<template>
    <div class="ring">
        ...
        <span class="icon" :class="{ iconHidden: !(conditionBarCurr === 'inProgress') }"> {{ `${valNum}%` }} </span>
        ...
        <svg class="icon" :class="{ iconHidden: !(valNum >= 100) }" width="30" viewBox="0 0 512.008 512.008">
            <path path
...
const progress = computed(() => props.valNum / (props.isDashBar ? 133 : 100))
...
.dash-bar {
    ...
    stroke-dasharray: 254.46879 84.82293 339.29172
